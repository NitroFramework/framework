...
use Nitro\Database\Query\Grammar\PostgresGrammar;
...
class DB
{
     ...
     *
     * Deliberately does not create it, which would open a connection
     * just to establish that nothing is happening.
     */
