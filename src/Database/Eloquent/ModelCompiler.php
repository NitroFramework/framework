...
PHP;
    ...
    /**
     * The manifest read at runtime: which Laravel Model the compiled copy was made from, the PHP
     * version the plans were made with (the boot order follows the method order reflection
     * gives, which can differ between PHP versions), and the plans.
     */
    public static function export(array $stamp, array $plans, string $php = PHP_VERSION): string
    {
        return "<?php\n\n// Generated by `php artisan eloquent:cache` (Nitro). Do not edit.\n\nreturn "
            .var_export(['laravel' => $stamp, 'php' => $php, 'plans' => $plans], true).";\n";
    }
}
