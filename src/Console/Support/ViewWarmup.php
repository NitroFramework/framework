...
// opcache_is_script_cached() first: it answers from memory and returns false for
// a path that no longer exists, so the is_file() it used to sit behind was a stat
