...
/**
 * resolve() is the framework's standard way to ask the container for an
...
class ResolveTest extends TestCase
{
    public function test_it_resolves_a_registered_binding(): void
    {
        ...
        $this->assertSame('bound', $c->resolve('thing')->tag);
    }
    ...
    public function test_it_creates_an_unbound_class_by_auto_wiring(): void
    {
        ...
        $needs = $c->resolve(CorNeedsService::class);
    ...
    public function test_make_is_the_same_method_under_its_conventional_name(): void
    {
        ...
        $this->assertSame($c->resolve('thing'), $c->resolve('thing'));
        $this->assertInstanceOf(CorNeedsService::class, $c->resolve(CorNeedsService::class));
    }
    ...
    public function test_a_singleton_resolves_to_the_same_instance_either_way(): void
    {
        ...
        $this->assertSame($c->resolve(CorService::class), $c->resolve(CorService::class));
    }
    ...
    public function test_constructor_overrides_are_honoured(): void
    {
        ...
        $this->assertSame('explicit', $c->resolve(CorService::class, ['tag' => 'explicit'])->tag);
    }
    ...
    public function test_create_or_resolve_auto_wires_where_get_would_throw(): void
    {
        ...
        // container — get() refuses, resolve() builds it.
        $c = new Container();

        $this->assertInstanceOf(CorService::class, $c->resolve(CorService::class));
    }
    ...
    public function test_both_agree_once_the_binding_exists(): void
    {
        ...
        $this->assertSame($c->get(CorService::class), $c->resolve(CorService::class));
    }
}
